...
class DSBranch(nn.Layer):
    ...
    def __init__(self, pretrained=None):
        ...
        self.down4 = nn.Sequential(
            nn.Conv2D(128, 256, kernel_size=3, stride=2, padding=3//2, bias_attr=False),
        ...
        self.down5 = nn.Sequential(
            ...
            SyncBatchNorm(256, data_format='NCHW'),
            nn.ReLU(),
            nn.Conv2D(256, 512, kernel_size=3, stride=2, padding=3//2, bias_attr=False),
        ...
        self.conv_smooth128 = layers.ConvBNReLU(128, 128, 3)
    ...
    def forward(self, x):
        ...
        feat_32_up = F.interpolate(feat_32, size=paddle.shape(feat_8)[2:], mode='bilinear')
...
class PagFM(nn.Layer):
    def __init__(self, in_channels, mid_channels, after_relu=False, BatchNorm=nn.BatchNorm2D):
        ...
        self.f_x = nn.Sequential(
            ...
            # Conv_BN(in_channels=in_channels, out_channels=mid_channels, kernel=1)
        )
