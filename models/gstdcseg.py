...
class SegHead(nn.Layer):
    def __init__(self, in_chan, mid_chan, n_classes):
        ...
        self.conv = nn.Sequential(nn.Dropout(0.1),
            layers.ConvBNReLU(in_chan, mid_chan, kernel_size=3, stride=1, padding=1))
...
class FeatureFusionModule(nn.Layer):
    def __init__(self, in_chan, out_chan):
        ...
        self.convblk = ConvBNPRelu(
            in_chan, out_chan, kernel=1, stride=1)
