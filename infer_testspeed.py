...
class Predictor:
    ...
    def run(self, imgs):
        ...
        for i in range(0, num, self.args.batch_size):
            ...
            timer_sum += timer.elapsed_time()
            print(['speed:', speed, 'time:', timer.elapsed_time()])

            output_names = self.predictor.get_output_names()
            output_handle = self.predictor.get_output_handle(output_names[0])
            results.append(output_handle.copy_to_cpu())

        avgspeed = num / timer_sum
        print(['avg_speed:', avgspeed])
        sys.exit()
...
def get_images(image_path, support_ext=".jpg|.jpeg|.png"):
    ...
    imgs = []
    print("Testing file is :", image_path.split('/')[-1])
...
if __name__ == '__main__':
    args = parse_args()
    # args.cfg = '/mnt/HDD_2T/XJL/home_2.5/output/testspeed/export/deploy.yaml'
    # args.model_path = '/home/praiselab/YHT/home_2.5/output/a0904/G2_arm_pag2_1536x768-pre50-7773/best_model/model.pdparams'
    # args.image_path = '/mnt/HDD_2T/XJL/home_2.5/datasets/cityscapes/leftImg8bit/val/lindau'
